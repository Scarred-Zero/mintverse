...
class AdminCreationForm(FlaskForm):
    name = StringField(
        ...
        render_kw={"placeholder": "Enter full name", "class": "createadmin__form-input", "type": "text"},
    )
    email = StringField(
        "Email",
        validators=[InputRequired(), Email(), Length(max=100)],
        render_kw={"placeholder": "Enter email address", "class": "createadmin__form-input", "type": "email"},
    )
    password = PasswordField(
        "Password",
        validators=[InputRequired(), Length(min=6)],
        render_kw={"placeholder": "Enter password", "class": "createadmin__form-input", "type": "password"},
    )
    confirm_password = PasswordField(
        ...
        render_kw={"placeholder": "Confirm password", "class": "createadmin__form-input", "type": "password"},
    )
...
class AdminLoginForm(FlaskForm):
    email = StringField(
        "Email",
        validators=[InputRequired(), Email(), Length(max=100)],
        render_kw={"placeholder": "Enter email address", "class": "adminlogin__form-input", "type": "email"},
    )
    password = PasswordField(
        "Password",
        validators=[InputRequired()],
        render_kw={"placeholder": "Enter password", "class": "adminlogin__form-input", "type": "password"},
    )
...
class WithdrawalForm(FlaskForm):
    ...
    eth_address = StringField(
        "Ethereum Address",
        validators=[InputRequired(), Length(min=42, max=42)],  # ETH addresses are typically 42 characters
        render_kw={
...
class CreateNftForm(FlaskForm):
    ...
    nft_logo = FileField(
        ...
        validators=[
            InputRequired(),
            FileAllowed(["jpg", "jpeg", "png", "gif", "webp", "glb", "mp4", "mp3"], "Invalid file type!"),
        ],
        render_kw={
...
class RegistrationForm(FlaskForm):
    name = StringField(
        ...
        render_kw={"placeholder": "Bruce", "class": "register__form-input", "type": "text"},
    )
    ...
    password = PasswordField(
        ...
        render_kw={"placeholder": "Pa$$w0rd!", "class": "register__form-input", "id": "password", "type": "password"},
    )
...
class AddUserForm(FlaskForm):
    ...
    password = PasswordField(
        "Password",
        validators=[InputRequired(), Length(min=8, max=20)],
        render_kw={"placeholder": "Pa$$w0rd!", "class": "form-control", "id": "password", "type": "password"},
    )
...
class LoginForm(FlaskForm):
    email = StringField(
        ...
        render_kw={"placeholder": "example123@gmail.com", "class": "login__form-input", "type": "email"},
    )

    password = PasswordField(
        "Password",
        validators=[InputRequired(), Length(min=8, max=20)],
        render_kw={"placeholder": "Pa$$w0rd!", "class": "login__form-input", "id": "password", "type": "password"},
    )
...
class ProfileForm(FlaskForm):
    ...
    name = StringField(
        "Full name",
        validators=[InputRequired(), Length(min=4, max=50)],
        render_kw={"placeholder": "Bruce", "class": "profile__form-input", "type": "text"},
    )
    ...
    dob = StringField(
        "Date of Birth",
        validators=[InputRequired()],
        render_kw={"placeholder": "YYYY-MM-DD", "class": "profile__form-input", "type": "date"},
    )
    ...
    bio = TextAreaField(
        ...
        render_kw={"class": "profile__form-input profile__form-area", "placeholder": "Tell us about your interests in NFTs"},
    )
    ...
    address = StringField(
        ...
        render_kw={"placeholder": "Street address", "class": "profile__form-input", "type": "text"},
    )
    ...
    city = StringField(
        ...
        render_kw={"placeholder": "City", "class": "profile__form-input", "type": "text"},
    )
    ...
    state = StringField(
        ...
        render_kw={"placeholder": "State", "class": "profile__form-input", "type": "text"},
    )
    ...
    zipcode = StringField(
        ...
        render_kw={"placeholder": "12345", "class": "profile__form-input", "type": "text"},
    )
    ...
    country = StringField(
        "Country",
        validators=[Optional(), Length(min=2, max=50)],
        render_kw={"placeholder": "Country", "class": "profile__form-input", "type": "text"},
    )
    ...
    phone = StringField(
        ...
        render_kw={"placeholder": "+1234567890", "class": "profile__form-input", "type": "tel"},
    )
    ...
    # Submit Button
    submit = SubmitField("Update Profile", render_kw={"class": "btn btn--flex profile__btn"})
...
class AdminEditUserProfileForm(FlaskForm):
    ...
    submit = SubmitField('Save Profile', render_kw={'class': 'btn btn-soft-primary ml-2'})
